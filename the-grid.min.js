...
!function(t) {
    function e(t) {
        ...
        function n(e, n) {
            t.fn[e] = function(o) {
                if ("string" == typeof o) {
                    for (var r = i.call(arguments, 1), a = 0, s = this.length; a < s; a++) {
                        var l = this[a]
                          , u = t.data(l, e);
                        if (u && (t.isFunction(u[o]) && "_" !== o.charAt(0))) {
                            var d = u[o].apply(u, r);
                            if (void 0 !== d)
                                return d
                        }
    ...
    "function" == typeof define && define.amd ? define("jquery-bridget/jquery.bridget", ["jquery"], e) : e("object" == typeof exports ? require("jquery") : t.jQuery)
}(window),
function(t) {
    function e(e) {
        var i = t.event;
...
function() {
    ...
    n.removeListener = function(t, i) {
        ...
        for (o in r)
            r.hasOwnProperty(o) && -1 !== (n = e(r[o], i)) && r[o].splice(n, 1);
        return this
    }
    ,
    ...
    n.manipulateListeners = function(t, e, i) {
        var n, o, r = t ? this.removeListener : this.addListener, a = t ? this.removeListeners : this.addListeners;
        if ("object" != typeof e || e instanceof RegExp)
            for (n = i.length; n--; )
                r.call(this, e, i[n]);
        else
            for (n in e)
                e.hasOwnProperty(n) && (o = e[n]) && ("function" == typeof o ? r.call(this, n, o) : a.call(this, n, o));
        return this
    }
    ,
    ...
    n.emitEvent = function(t, e) {
        ...
        for (o in r)
            if (r.hasOwnProperty(o))
                for (n = r[o].length; n--; )
                    !0 === (i = r[o][n]).once && this.removeListener(t, i.listener),
    ...
    function o(e) {
        ...
        function s(e, i) {
            ...
            var n = e.style
              ...
              , r = e.runtimeStyle
              , a = r && r.left;
            return a && (r.left = e.currentStyle.left),
            n.left = i,
            i = n.pixelLeft,
            n.left = o,
            a && (r.left = a),
        ...
        return function(t) {
            ...
            t && "object" == typeof t && t.nodeType) {
                ...
                for (var c = r.isBorderBox = !(!u || !e[u] || "border-box" !== e[u]), h = 0, f = a.length; h < f; h++) {
                    var p = a[h]
                      , m = e[p];
                    m = s(t, m);
                    var g = parseFloat(m);
...
function(t, e) {
    ...
    n.filterFindElements = function(t, e) {
        for (var o = [], r = 0, a = (t = n.makeArray(t)).length; r < a; r++) {
            var s = t[r];
            if (n.isElement(s))
                if (e) {
                    i(s, e) && o.push(s);
                    for (var l = s.querySelectorAll(e), u = 0, d = l.length; u < d; u++)
                        o.push(l[u])
                } else
                    o.push(s)
        }
    ...
    return n.htmlInit = function(i, o) {
        e(function() {
            for (var e = n.toDashed(o), a = document.querySelectorAll(".js-" + e), s = "data-" + e + "-options", l = 0, u = a.length; l < u; l++) {
                var d, c = a[l], h = c.getAttribute(s);
                try {
                    d = h && JSON.parse(h)
                } catch (t) {
...
function(t, e) {
    ...
    a.prototype.getPosition = function() {
        var t = l(this.element)
          ...
          , u = -1 != r.indexOf("%") ? parseFloat(r) / 100 * a.height : parseInt(r, 10);
        s = isNaN(s) ? 0 : s,
        u = isNaN(u) ? 0 : u,
        s -= i ? a.paddingLeft : a.paddingRight,
        u -= n ? a.paddingTop : a.paddingBottom,
        this.position.x = s,
        this.position.y = u
    }
    ,
    ...
    a.prototype.getTranslate = function(t, e) {
        ...
        e = i.isOriginTop ? e : -e,
        h ? "translate3d(" + t + "px, " + e + "px, 0)" : "translate(" + t + "px, " + e + "px)"
    }
    ,
    ...
    ;
    var g = "opacity," + (m.transform || "transform").replace(/([A-Z])/g, function(t) {
...
function(t, e) {
    ...
    a.prototype._layoutItems = function(t, e) {
        ...
        t && t.length) {
            for (var i = [], n = 0, o = t.length; n < o; n++) {
                ...
                a.item = r,
                a.isInstant = e || r.isLayoutInstant,
                i.push(a)
            }
    ...
    a.prototype.getItems = function(t) {
        for (var e = [], i = 0, n = (t = o.makeArray(t)).length; i < n; i++) {
            var r = t[i]
              , a = this.getItem(r);
            a && e.push(a)
        }
...
function(t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define("TG_Layout/js/item", ["outlayer/outlayer"], e) : "object" == typeof exports ? module.exports = e(require("outlayer")) : (t.TG_Layout = t.TG_Layout || {},
...
function(t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define("TG_Layout/js/layout-mode", ["get-size/get-size", "outlayer/outlayer"], e) : "object" == typeof exports ? module.exports = e(require("get-size"), require("outlayer")) : (t.TG_Layout = t.TG_Layout || {},
    ...
    return function() {
        for (var t = ["_resetLayout", "_getItemLayoutPosition", "_getContainerSize", "_getElementOffset", "needsResizeLayout"], n = 0, o = t.length; n < o; n++) {
            var r = t[n];
    ...
    i.prototype.needsVerticalResizeLayout = function() {
        ...
        return this.TG_Layout.size && e && e.innerHeight != this.TG_Layout.size.innerHeight
    }
    ,
    ...
    i.prototype.getSegmentSize = function(t, e) {
        ...
        !this[i]) {
            ...
            this[i] = o && o[n] || this.TG_Layout.size["inner" + e]
        }
    }
    ,
...
function(t, e) {
    ...
    n.prototype._getItemLayoutPosition = function(t) {
        ...
        if (this.options.isFitRows) {
            ...
            0 !== this.x && l + this.x > u && (this.x = 0,
            this.y = this.maxY)
        } else
            this.x = this.columnWidth * s,
            this.y = a;
        var d = {
            x: this.x,
            y: this.y
        };
        this.options.isFitRows && (this.maxY = Math.max(this.maxY, this.y + t.size.outerHeight + this.gutter),
        this.x += l);
        for (var c = a + t.size.outerHeight + this.gutter, h = this.cols + 1 - r.length, f = 0; f < h; f++)
            this.colYs[s + f] = c;
        return d
    }
    ,
...
function(t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "matches-selector/matches-selector", "fizzy-ui-utils/utils", "TG_Layout/js/item", "TG_Layout/js/layout-mode", "TG_Layout/js/layout-modes/masonry"], function(i, n, o, r, a, s) {
        return e(t, i, n, o, r, a, s)
    }) : "object" == typeof exports ? module.exports = e(t, require("outlayer"), require("get-size"), require("desandro-matches-selector"), require("fizzy-ui-utils"), require("./item"), require("./layout-mode"), require("./layout-modes/masonry")) : t.TG_Layout = e(t, t.Outlayer, t.getSize, t.matchesSelector, t.fizzyUIUtils, t.TG_Layout.Item, t.TG_Layout.LayoutMode)
    ...
    : function(t) {
      ...
      , d = document.documentElement.textContent ? function(t) {
...
function(t, e) {
    ...
    t.prototype.getMaximalFreeRects = function(e) {
        if (!this.overlaps(e))
            return !1;
        var i, n = [], o = this.x + this.width, r = this.y + this.height, a = e.x + e.width, s = e.y + e.height;
...
function(t, e) {
    ...
    n.prototype.getPlaceRectCoord = function(t, e, i) {
        ...
        e || (a = Math.max(a, this.layout.maxY),
...
function(t, e) {
    ...
    ;
    var s = n.prototype._getItemLayoutPosition;
    return n.prototype._getItemLayoutPosition = function(t) {
...
function(t) {
    ...
    function e(t) {
        ...
        return e.prototype._resetLayout = function() {
            ...
            if (this.options.isHorizontal)
                ...
                t: for (; e.length > 0; ) {
                    ...
                    this.setHeight(o, Math.min(this.rowHeight, r)),
                    i++;
                    break
                }
                this.checkWidth()
        ...
        e.prototype.row = function(t) {
            for (var e = this.options.row, i = this.rowHeight, n = 0; n < t.length; ++n) {
                var o = jQuery(t[n].element).find(this.options.image)
                  , r = o[0] ? this.getSize(o) : []
                  , a = r.width ? Math.round(i * r.width / r.height) : 16 * i / 9
                  , s = this.justified_data[n - e]
                  , l = s ? s.x + s.width + this.gutter : 0
                  , u = s ? s.y : n * (i + this.gutter);
        ...
        e.prototype.setHeight = function(t, e) {
            ...
            for (var i = 0; i < t.length; ++i) {
                var n = jQuery(t[i].element).find(this.options.image)
                  , e = Math.round(e)
                  , o = n[0] ? this.getSize(n) : []
                  , r = o.width ? Math.round(e * o.width / o.height) : 16 * e / 9;
                this.justified_data.push({
                    width: r,
                    height: e,
                    x: this.prev_width,
        ...
        e.prototype.getSize = function(t) {
            if (t[0].naturalWidth)
                ...
                var n = new Image;
                n.src = t[0] ? t.attr("src") : null;
                var e = n ? n.width : null
                  , i = n ? n.height : null
            }
            return {
                width: e,
        ...
        e.prototype.checkWidth = function() {
            for (var t = 0, e = this.justified_data.length, i = 0; i < this.justified_data.length; ++i)
                this.justified_data[i].y != t && this.adjustWidth(i - 1),
                t = this.justified_data[i].y;
            var n = this.justified_data[e - 1];
            n && n.x + n.width > this.TG_Layout.size.innerWidth && this.adjustWidth(e - 1)
        }
        ,
        e.prototype.adjustWidth = function(t) {
            var e = this.justified_data[t].x
              , i = this.justified_data[t].width
              , n = this.TG_Layout.size.innerWidth - (e + i);
            this.justified_data[t].width = i + n
        }
        ,
        e.prototype._getItemLayoutPosition = function(t) {
            if (!this.justified_data[this.count]) {
                ...
                for (var e = 0; e < this.pcount; ++e) {
                    ...
                    n = this.justified_data[e].x + this.justified_data[e].width;
                    this.max_width = n > this.max_width ? n : this.max_width
                }
                this.count = this.pcount
            }
            t.element.style.width = this.justified_data[this.count].width + "px",
            t.element.style.height = this.justified_data[this.count].height + "px";
            var i = {
                x: this.justified_data[this.count].x,
                y: this.justified_data[this.count].y
            }
              , n = i.x + this.justified_data[this.count].width;
            return this.max_width = n > this.max_width ? n : this.max_width,
            ++this.count,
            i
        }
        ,
...
function(t) {
    ...
    TG_Layout.Item.prototype.reveal = function() {
        ...
        t(this.element).removeClass("tg-item-hidden")
    }
    ;
    var i = TG_Layout.Item.prototype.hide;
    TG_Layout.Item.prototype.hide = function() {
        i.apply(this, arguments),
        t(this.element).addClass("tg-item-hidden")
    }
}(jQuery),
function(t, e, i) {
    "use strict";
    function n(e, b, E) {
        function M(e) {
            var i = bt.length
              , n = dt.data("TG_Layout")
              , o = n ? n.options[n.options.layoutMode].gutter.offsetWidth : 0;
            if (!n)
                return !1;
            if (ct = ut.width(),
            gt = pt.width(),
            ...
            Et) {
                xt.length,
                Tt = dt.children(at.itemSelector),
                xt.length = 0;
                for (var r, a = u(dt, at.horizontal ? "paddingLeft" : "paddingTop"), s = u(dt, at.horizontal ? "paddingRight" : "paddingBottom"), l = "border-box" === t(Tt).css("boxSizing"), c = n.filteredItems, h = 0, f = 0, p = [], m = [], g = 0; g < c.length; g++) {
                    var y = parseFloat(getComputedStyle(c[g].element).width) + o
                      , v = c[g].position.x;
                    f = v + y > f ? v + y : f,
                    p.push(v)
                }
                ...
                t(c).each(function(t, e) {
                    ...
                    l.half = l.size / 2,
                    l.start = ht - i,
                    l.center = l.start - G(ct / 2 - l.size / 2),
                    l.end = l.start - ct + l.size,
                    t || (ht += a),
                    ht += l.size,
                    at.horizontal || n && i && t > 0 && (ht -= j(i, n)),
                    0 === t && (l.end += s,
                    ht += s,
                    h = n),
                    l.size && (xt.push(l),
                ...
                dt[0].style[at.horizontal ? "width" : "height"] = (l ? ht : ht - a - s) + "px",
                ht -= h,
                xt.length ? (ft.start = xt[0][Pt ? "center" : "start"],
                ft.end = Pt ? r.center : ct < ht ? r.end : ft.start) : ft.start = ft.end = 0
            }
            if (ft.center = G(ft.end / 2 + ft.start / 2),
            H(),
            !lt && ct > 0) {
                var _ = ft.start
                  , w = "";
                if (Et)
                    t.each(xt, function(t, e) {
                        Pt ? bt.push(e.center) : e.start + e.size > _ && _ <= ft.end && (_ = e.start,
                        bt.push(e.size < ct && "justified" === n.options.layoutMode ? e.start + (e.size - ct) / 2 : e.start),
                        (_ += ct) > ft.end && _ < ft.end + ct && bt.push(ft.end))
                    });
                else
                    for (; _ - ct < ft.end; )
                        bt.push(_),
                        _ += ct;
                if (_t[0] && i !== bt.length) {
                    for (g = 0; g < bt.length; g++)
                        w += at.pageBuilder.call(st, g);
                    1 === bt.length && (w = null),
                    (wt = _t.html(w).children()).eq(zt.activePage).addClass(at.activeClass)
                }
            }
            if (zt.slideeSize = ht,
            zt.frameSize = ct,
            ...
            zt.handleSize = yt,
            Et) {
                e && null != at.startAt && st[jt ? "toCenter" : "toStart"](at.startAt);
                var b = xt[zt.activeItem];
                k(jt && b ? b.center : d(ft.dest, ft.start, ft.end))
            } else
                e ? null != at.startAt && k(at.startAt, 1) : k(d(ft.dest, ft.start, ft.end));
            nt("load")
        }
        function k(t, e, i) {
            if (Et && Nt.released && !i) {
                var n = A(t)
                  , o = t > ft.start && t < ft.end;
                jt ? (o && (t = xt[n.centerItem].center),
                Pt && at.activateMiddle && activate(n.centerItem)) : o && (t = xt[n.firstItem].start)
            }
            Nt.init && Nt.slidee && at.elasticBounds ? t > ft.end ? t = ft.end + (t - ft.end) / 6 : t < ft.start && (t = ft.start + (t - ft.start) / 6) : t = d(t, ft.start, ft.end),
            Bt.start = +new Date,
            Bt.time = 0,
            Bt.from = ft.cur,
            Bt.to = t,
            Bt.delta = t - ft.cur,
            Bt.tweesing = Nt.tweese || Nt.init && !Nt.slidee,
            Bt.immediate = !Bt.tweesing && (e || Nt.init && Nt.slidee || !at.speed),
            Nt.tweese = 0,
            t !== ft.dest && (ft.dest = t,
            nt("change"),
            Yt || D()),
        ...
        function D() {
            if (st.initialized) {
                if (!Yt)
                    return Yt = g(D),
                    void (Nt.released && nt("moveStart"));
                Bt.immediate ? ft.cur = Bt.to : Bt.tweesing ? (Bt.tweeseDelta = Bt.to - ft.cur,
                C(Bt.tweeseDelta) < .1 ? ft.cur = Bt.to : ft.cur += Bt.tweeseDelta * (Nt.released ? at.swingSpeed : at.syncSpeed)) : (Bt.time = j(+new Date - Bt.start, at.speed),
                ft.cur = Bt.from + Bt.delta * t.easing[at.easing](Bt.time / at.speed, Bt.time, 0, 1, at.speed)),
                Bt.to === ft.cur ? (ft.cur = Bt.to,
                Nt.tweese = Yt = 0) : Yt = g(D),
                nt("move"),
                lt || (h ? dt[0].style[h] = f + (at.horizontal ? "translateX" : "translateY") + "(" + -ft.cur + "px)" : dt[0].style[at.horizontal ? "left" : "top"] = -G(ft.cur) + "px"),
                !Yt && Nt.released && nt("moveEnd")
            }
        }
        function R() {
            wt[0] && Ht.page !== zt.activePage && (Ht.page = zt.activePage,
            wt.removeClass(at.activeClass).eq(zt.activePage).addClass(at.activeClass),
            nt("activePage", Ht.page))
        }
        function O() {
            Ft.speed && ft.cur !== (Ft.speed > 0 ? ft.end : ft.start) || st.stop(),
            Vt = Nt.init ? g(O) : 0,
            Ft.now = +new Date,
            Ft.pos = ft.cur + (Ft.now - Ft.lastTime) / 1e3 * Ft.speed,
            k(Nt.init ? Ft.pos : G(Ft.pos)),
            Nt.init || ft.cur !== ft.dest || nt("moveEnd"),
            Ft.lastTime = Ft.now
        }
        function W(t, e, n) {
            if ("boolean" === o(e) && (n = e,
        ...
        function q(t) {
            return null != t ? l(t) ? t >= 0 && t < xt.length ? t : -1 : Tt.index(t) : -1
        }
        function A(t) {
            t = d(l(t) ? t : ft.dest, ft.start, ft.end);
            var e = {}
              , i = Pt ? 0 : ct / 2;
            if (!lt)
                for (var n = 0, o = bt.length; n < o; n++) {
                    if (t >= ft.end || n === bt.length - 1) {
            ...
            if (Et) {
                for (var r = !1, a = !1, s = !1, u = 0, c = xt.length; u < c; u++)
                    if (!1 === r && t <= xt[u].start + xt[u].half && (r = u),
        ...
        function B() {
            var t = ft.dest <= ft.start
              , e = ft.dest >= ft.end
              , i = (t ? 1 : 0) | (e ? 2 : 0);
            if (Ht.slideePosState !== i && (Ht.slideePosState = i,
            Wt.is("button,input") && Wt.prop("disabled", t),
            qt.is("button,input") && qt.prop("disabled", e),
            Wt.add(Dt)[t ? "addClass" : "removeClass"](at.disabledClass),
            qt.add(kt)[e ? "addClass" : "removeClass"](at.disabledClass)),
            Ht.fwdbwdState !== i && Nt.released && (Ht.fwdbwdState = i,
            Dt.is("button,input") && Dt.prop("disabled", t),
            kt.is("button,input") && kt.prop("disabled", e)),
            Et && null != zt.activeItem) {
                var n = 0 === zt.activeItem
                  , o = zt.activeItem >= xt.length - 1
                  , r = (n ? 1 : 0) | (o ? 2 : 0);
                Ht.itemsButtonState !== r && (Ht.itemsButtonState = r,
                Rt.is("button,input") && Rt.prop("disabled", n),
                Ot.is("button,input") && Ot.prop("disabled", o),
                Rt[n ? "addClass" : "removeClass"](at.disabledClass),
                Ot[o ? "addClass" : "removeClass"](at.disabledClass))
            }
        }
        function F(t, e) {
            for (var i = 0, n = At[t].length; i < n; i++)
                if (At[t][i] === e)
                    return i;
            return -1
        }
        ...
        function Y(t) {
            return G(d(t, vt.start, vt.end) / vt.end * (ft.end - ft.start)) + ft.start
        }
        function Q() {
        ...
        function V(e) {
            var i = "touchstart" === e.type
              , n = e.data.source
              , o = "slidee" === n;
            Nt.init || !i && Z(e.target) || ("handle" !== n || at.dragHandle && vt.start !== vt.end) && (o && !(i ? at.touchDragging : at.mouseDragging && e.which < 2) || (i || r(e),
            X(n),
            Nt.init = 0,
            ...
            Nt.locked = 0,
            Nt.history = [0, 0, 0, 0],
            Nt.pathToLock = o ? i ? 30 : 10 : 0,
            y.on(i ? w : _, U),
            st.pause(1),
            (o ? dt : mt).addClass(at.draggedClass),
            nt("moveStart"),
            o && (Qt = setInterval(Q, 10))))
        }
        function U(t) {
            if (Nt.released = "mouseup" === t.type || "touchend" === t.type,
            Nt.pointer = Nt.touch ? t.originalEvent[Nt.released ? "changedTouches" : "touches"][0] : t,
            ...
            Nt.released || !(Nt.path < 1)) {
                if (!Nt.init) {
                    if (!(at.horizontal ? C(Nt.pathX) > C(Nt.pathY) : C(Nt.pathX) < C(Nt.pathY)))
                        return $();
                    Nt.init = 1
                }
                r(t),
                ...
                Nt.$source.on(T, a)),
                Nt.released && ($(),
                at.releaseSwing && Nt.slidee && (Nt.swing = (Nt.delta - Nt.history[0]) / 40 * 300,
                Nt.delta += Nt.swing,
                Nt.tweese = C(Nt.swing) > 10)),
                k(Nt.slidee ? G(Nt.initPos - Nt.delta) : Y(Nt.initPos + Nt.delta))
            }
        }
        function $() {
            clearInterval(Qt),
            ...
            ft.cur === ft.dest && Nt.init && nt("moveEnd"),
            st.resume(1),
            Nt.init = 0
        }
        function Z(e) {
        ...
        function K(t) {
            ...
            case kt[0]:
            case Dt[0]:
                st.moveBy(kt.is(this) ? at.moveBy : -at.moveBy),
                y.on("mouseup", J);
                break;
            case Rt[0]:
                st.prev();
        ...
        function tt(t) {
            if (at.keyboardNavBy)
                ...
                case at.horizontal ? 37 : 38:
                    r(t),
                    st["pages" === at.keyboardNavBy ? "prevPage" : "prev"]();
                    break;
                case at.horizontal ? 39 : 40:
                    r(t),
                    st["pages" === at.keyboardNavBy ? "nextPage" : "next"]()
                }
        }
        function et() {
        ...
        var ot, rt, at = t.extend({}, n.defaults, b), st = this, lt = l(e), ut = t(e), dt = at.slidee ? t(at.slidee).eq(0) : ut.children().eq(0), ct = 0, ht = 0, ft = {
            start: 0,
            center: 0,
            end: 0,
            cur: 0,
            dest: 0
        }, pt = t(at.scrollBar).eq(0), mt = pt.children().eq(0), gt = 0, yt = 0, vt = {
            start: 0,
            end: 0,
            cur: 0
        }, _t = t(at.pagesBar), wt = 0, bt = [], Tt = 0, xt = [], zt = {
            firstItem: 0,
            lastItem: 0,
            centerItem: 0,
            activeItem: null,
            activePage: 0
        }, Lt = new c(ut[0]), Ct = new c(dt[0]), It = new c(pt[0]), St = new c(mt[0]), Gt = "basic" === at.itemNav, Pt = "forceCentered" === at.itemNav, jt = "centered" === at.itemNav || Pt, Et = !lt && (Gt || jt || Pt), Mt = (at.scrollSource && t(at.scrollSource),
        at.dragSource ? t(at.dragSource) : ut), kt = t(at.forward), Dt = t(at.backward), Rt = t(at.prev), Ot = t(at.next), Wt = t(at.prevPage), qt = t(at.nextPage), At = {}, Ht = {}, Bt = {}, Ft = {}, Nt = {
            released: 1
        }, Yt = 0, Qt = 0, Xt = 0, Vt = 0;
        lt || (e = ut[0]),
        st.initialized = 0,
        ...
        st.getPos = function(t) {
            ...
            if (i[0]) {
                var n = at.horizontal ? i.offset().left - dt.offset().left : i.offset().top - dt.offset().top
                  , o = i[at.horizontal ? "outerWidth" : "outerHeight"]();
                return {
                    start: n,
                    center: n - ct / 2 + o / 2,
                    end: n - ct + o,
        ...
        st.moveBy = function(t) {
            Ft.speed = t,
            !Nt.init && Ft.speed && ft.cur !== (Ft.speed > 0 ? ft.end : ft.start) && (Ft.lastTime = +new Date,
            Ft.startPos = ft.cur,
            X("button"),
            Nt.init = 1,
            nt("moveStart"),
        ...
        st.slideBy = function(t, e) {
            t && (Et ? st[jt ? "toCenter" : "toStart"](d((jt ? zt.centerItem : zt.firstItem) + at.scrollBy * t, 0, xt.length)) : k(ft.dest + t, e))
        }
        ,
        ...
        st.activatePage = function(t, e) {
            l(t) && k(bt[d(t, 0, bt.length - 1)], e)
        }
        ,
        st.resume = function(t) {
            at.cycleBy && at.cycleInterval && ("items" !== at.cycleBy || xt[0] && null != zt.activeItem) && !(t < st.isPaused) && (st.isPaused = 0,
            Xt ? Xt = clearTimeout(Xt) : nt("resume"),
            Xt = setTimeout(function() {
                switch (nt("cycle"),
                at.cycleBy) {
                case "items":
                    st.activate(zt.activeItem >= xt.length - 1 ? 0 : zt.activeItem + 1);
                    break;
                case "pages":
                    st.activatePage(zt.activePage >= bt.length - 1 ? 0 : zt.activePage + 1)
                }
            }, at.cycleInterval))
        }
        ,
        st.pause = function(t) {
            t < st.isPaused || (st.isPaused = t || 100,
        ...
        st.init = function() {
            if (!st.initialized) {
                ...
                St.save.apply(St, e);
                var i = mt;
                return lt || (i = i.add(dt),
                ut.css("overflow", "hidden"),
                h || "static" !== ut.css("position") || ut.css("position", "relative")),
                h ? f && i.css(h, f) : ("static" === pt.css("position") && pt.css("position", "relative"),
                i.css({
                    position: "absolute"
                })),
                at.forward && kt.on(x, K),
                at.backward && Dt.on(x, K),
                at.prev && Rt.on(T, K),
                at.next && Ot.on(T, K),
                at.prevPage && Wt.on(T, K),
                at.nextPage && qt.on(T, K),
                _t[0] && at.activatePageOn && _t.on(at.activatePageOn + "." + p, "*", et),
                Mt.on(v, {
                    source: "slidee"
                }, V),
                mt && mt.on(v, {
                ...
                y.on("keydown", tt),
                lt || (ut.on("mouseenter." + p + " mouseleave." + p, it),
                ut.on("scroll." + p, s)),
                st.initialized = 1,
                M(!0),
    ...
    var h, f, p = "TG_Slider", m = e.cancelAnimationFrame || e.cancelRequestAnimationFrame, g = e.requestAnimationFrame, y = t(document), v = "touchstart." + p + " mousedown." + p, _ = "mousemove." + p + " mouseup." + p, w = "touchmove." + p + " touchend." + p, b = (document.implementation.hasFeature("Event.wheel", "3.0") ? "wheel." : "mousewheel.") + p, T = "click." + p, x = "mousedown." + p, z = ["INPUT", "SELECT", "BUTTON", "TEXTAREA"], L = [], C = Math.abs, I = Math.sqrt, S = Math.pow, G = Math.round, P = Math.max, j = Math.min, E = 0;
    y.on(b, function(t) {
        var e = t.originalEvent[p]
          , i = +new Date;
    ...
    function() {
        ...
        h = t("transform"),
        f = t("perspective") ? "translateZ(0) " : ""
    }(),
    e.TG_Slider = n,
    t.fn.TG_Slider = function(e, i) {
        var r, a;
        return t.isPlainObject(e) || ("string" !== o(e) && !1 !== e || (r = !1 === e ? "destroy" : e,
        a = Array.prototype.slice.call(arguments, 1)),
        e = {}),
        this.each(function(o, s) {
            var l = t.data(s, p);
            l || r ? l && r && l[r] && l[r].apply(l, a) : l = t.data(s, p, new n(s,e,i).init())
        })
    }
}(jQuery, window);
var The_Grid = {
...
!function(t) {
    ...
    t.fn.The_Grid = function(e) {
        return this.each(function() {
            function e(t) {
                var e = rt.not(".tg-item-hidden").length;
                t.length === e && P.reload()
            }
            function i(e) {
                for (var i = 0; i < t(e).length; i++)
                    for (var n, o, r = t(e).eq(i), a = r.get(0).attributes, s = 0; s < a.length; s++)
                        n = a[s].name,
                        o = a[s].value,
                        0 === n.indexOf("data-") && "data-row" !== n && "data-col" !== n && (r.removeAttr(n),
                        r.data(n.replace("data-", ""), o),
                        s--)
            }
            function n(e) {
                if (!Y)
                    return !1;
                var i;
                rt.removeClass("tg-item-index"),
                lt.val(""),
                _t.filterComb ? (i = [],
                A = "*" === e.data("filter") ? e.nextAll("[data-filter]").removeClass("tg-filter-active") : e.prevAll('[data-filter="*"]').removeClass("tg-filter-active"),
                A = "*" === e.data("filter") ? e.closest("select").find("option").prop("selected", !1) : e.closest("select").find('[data-filter="*"]').prop("selected", !0),
                e.toggleClass("tg-filter-active"),
                Z.find(".tg-filter-active").each(function() {
                    "*" != t(this).data("filter") && i.push(t(this).data("filter"))
                }),
                i = "AND" === _t.filterLogic ? o(i) : i.join(", ")) : (i = e.data("filter"),
                st.removeClass("tg-filter-active"),
            ...
            function r() {
                at.each(function(e, i) {
                    var n = t(this).find(The_Grid.filter + ".tg-filter-active").length;
                    A = 0 === n && t(this).find('[data-filter="*"]').addClass("tg-filter-active")
                })
            }
            function a(t) {
                if (!Y)
                    return !1;
                L = "none" === t.data("value") ? "" : t.data("value"),
                C = t.text(),
                F = ht.data("asc"),
                rt.removeClass("tg-item-index"),
                dt.find(".tg-dropdown-value").text(C),
                H.TG_Layout({
                    sortAscending: F,
                    sortBy: L
                })
            ...
            function s() {
                if (_t.fullWidth && 0 === J.length) {
                    Z.css("left", 0);
                    var e = parseInt(Z.css("margin-left"))
                      , i = parseInt(Z.css("margin-right"))
                      , n = Z.offset().left - e;
                    Z.width(t(window).width() - (e + i)),
                    Z.css("left", -n)
                }
            }
            function l() {
                if (_t.gallery) {
                    var e;
                    d(),
                    !The_Grid.galleryInt && t(The_Grid.gallery).length > 0 && (The_Grid.galleryInt = setInterval(function() {
                        I = Math.floor(Math.random() * B.length),
                        S = S === I && B.length > 0 ? u(B, I + 1) : I,
                        e = t(The_Grid.gallery).eq(S),
                        G = B.length > 0 ? u(B[S], e.find(".show").index() - 1 + 2) : 0,
                        e.find(The_Grid.itemImg).removeClass("show"),
                        e.find(The_Grid.itemImg).eq(G).addClass("show")
                    }, 3500))
                }
            }
            function u(t, e) {
            ...
            function d() {
                ...
                for (var e = t(The_Grid.gallery), i = 0; i < e.length; i++) {
                    var n = t(e[i]).find(The_Grid.itemImg);
                    B[i] = [];
            ...
            function c() {
                for (var t = 0; t < st.length; t++) {
                    var e = st.eq(t).data("filter")
                      , i = gt.length > 0 ? ".tg-item-hidden" : null
                      , n = "*" !== e ? H.find(e).not(i).length : rt.not(i).length;
                    st.eq(t).find(The_Grid.tooltip).html(n),
                    A = st.eq(t).find("span:first-child").data("count") && st.eq(t).find("span:first-child").data("tooltip", n),
                    A = 0 === n ? st.eq(t).removeClass("tg-show-filter") : st.eq(t).addClass("tg-show-filter")
                }
            }
            function h() {
                if (et.length > 0)
                    if ((N = et.data("item-tt") ? et.data("item-tt") - rt.length : 99999) <= 0)
                        et.addClass("tg-no-more"),
                        et.find("span").html(et.data("no-more")),
                        setTimeout(function() {
                            et.fadeOut(500)
                        }, 3e3);
                    else {
                        var t = et.data("button");
                        A = et.data("remain") ? et.find("span").html(t + " (" + N + ")") : et.find("span").html(t)
                    }
            }
            function f() {
                var e, i = 0, n = H.data("TG_Layout");
                A = 0 === gt.length ? tt.remove() : tt.hide(),
                Z.removeClass("tg-grid-loading"),
                (z = n.filteredItems).length > 0 ? e = window.tgInterval(function() {
                    H.closest("body").length > 0 && (t(z[i].element).removeClass("tg-item-reveal"),
                    A = _t.itemDelay && H.TG_Layout("reveal", [z[i]]),
                    i !== z.length - 1 && _t.itemDelay || (Y = !0,
                    rt.removeClass("tg-item-reveal"),
                    Z.addClass("tg-grid-loaded"),
                    A = !_t.itemDelay && H.TG_Layout("reveal", z),
                    e.clear()),
                    i++)
                }, _t.itemDelay) : (Y = !0,
                rt.removeClass("tg-item-reveal"),
            ...
            function p() {
                for (var e = "justified" !== _t.style ? _t.cols : _t.rows, i = m().width, n = 0, o = e.length; n < o && e[n][0] >= i; n++)
                    D = e[n][1],
                    j = _t.gutters[n][1];
                if (ot.width(j),
                "justified" !== _t.style) {
                    var r = Z.width();
                    if (R = r / D - j,
                    "vertical" === _t.layout && (H.width(""),
                    R = (R = (r - (W = (D - 1) * j)) / D) % 1 != 0 ? Math.ceil(R) : R,
                    q = D * R + W,
                    H.css("left", -(q - H.width()) / 2 + "px"),
                    H.width(q)),
                    _t.fullHeight && "horizontal" === _t.layout) {
                        var a = t("#wpadminbar").height();
                        O = 0 === J.length ? (t(window).height() - a - j * (_t.row - 1)) / _t.row : J.height() / _t.row
                    } else
                        O = Math.round(R / _t.ratio)
                } else
                    O = D,
                    nt.height(O);
                A = "null" === _t.itemNav && K.css("padding", "0 " + j / 2 + "px")
            }
            function m() {
                if (0 === J.length) {
                    var t = window
            ...
            function g() {
                if ("justified" !== _t.style) {
                    nt.width(R);
                    for (var t = 0; t < rt.length; t++) {
                        var e = rt.eq(t).data("col")
                          , i = rt.eq(t).data("row");
                        i = "horizontal" === _t.layout && i > _t.row ? _t.row : i,
                        1 === D ? (E = R,
                        M = O) : D < e ? (k = Math.round(D / (e / i)),
                        E = D * R + (D - 1) * j,
                        M = 1 === (k = k <= 1 ? 1 : k) ? O : k * O + (k - 1) * j) : (E = e * R + (e - 1) * j,
                        M = i * O + (i - 1) * j),
                        rt.eq(t).width(E),
                        A = "grid" === _t.style ? rt.eq(t).height(M) : null
                    }
                }
            }
            function y() {
                if ("horizontal" === _t.layout) {
                    var e;
                    "masonry" === _t.style ? (Z.removeClass("tg-grid-loading"),
                    e = Math.max.apply(null, rt.map(function() {
                        return t(this).height()
                    }).get()),
                    H.add(K).height(e)) : (e = O * _t.row + j * (_t.row - 1),
                    H.add(K).height(e))
                }
            }
            function v() {
                var t, e, n = !1;
                "horizontal" === _t.layout ? (n = !0,
                t = e = "grid" === _t.style ? "packery" : "justified" === _t.style ? "justified" : "horizontal") : t = e = "grid" === _t.style ? "packery" : _t.style;
                var o = {};
                o[e] = {},
                o.hiddenStyle = {},
                o.visibleStyle = {},
                o.layoutMode = t,
                o.filter = _t.filterLoad,
                "none" !== _t.sortByLoad && (o.sortBy = _t.sortByLoad),
                o.sortAscending = _t.orderLoad,
                o.isOriginLeft = _t.rtl,
                o.itemSelector = The_Grid.item,
                o[e].gutter = ot[0],
                o[e].rowHeight = nt[0],
                o[e].columnWidth = nt[0],
                o[e].isHorizontal = n,
                o[e].isFitRows = _t.fitrows,
                o[e].image = The_Grid.itemImg,
                o[e].row = _t.row,
                o[e].previewMode = J,
                o.hiddenStyle.opacity = 0,
                o.visibleStyle.opacity = 1,
                o.hiddenStyle.transform = _t.animation.hidden,
                o.visibleStyle.transform = _t.animation.visible,
                o.transitionDuration = _t.transition,
                o.getSortData = The_Grid.sortData,
                H.TG_Layout(o),
                i(rt)
            }
            function _() {
                if ("horizontal" === _t.layout) {
                    var e = H.data("TG_Layout")
                      , i = e.filteredItems
                      , n = _t.startAt = _t.startAt - 1 > i.length ? i.length : _t.startAt;
                    "forceCentered" === _t.itemNav && 0 === mt.length && (mt = t(t('<div class="tg-slider-bullets"></div>')).appendTo(Z).hide()),
                    P = new TG_Slider(K,{
                        itemSelector: ".tg-item:not(.tg-item-hidden)",
                        cycleBy: _t.cycleBy,
                        cycleInterval: _t.cycle,
                        pauseOnHover: 1,
                        itemNav: _t.itemNav,
                        startAt: _t.startAt - 1,
                        smart: 1,
                        horizontal: 1,
                        easing: "easeOutExpo",
                        speed: 1e3,
                        swingSpeed: _t.swingSpeed,
                        releaseSwing: 1,
                        mouseDragging: 1,
                        touchDragging: 1,
                        elasticBounds: 1,
                    ...
                    K.data("slider", P).trigger("tg-slider-init"),
                    "forceCentered" === _t.itemNav && (t(i[n - 1].element).addClass("tg-active-item"),
                    P.on("load activePage", function(n) {
                        n = this.rel.activePage,
                        e = H.data("TG_Layout"),
                        i = e.filteredItems,
                        rt.removeClass("tg-active-item"),
                        A = i[n] && t(i[n].element).addClass("tg-active-item")
                    }))
                }
            }
            function w(e) {
                ...
                V = t.ajax({
                    ...
                    beforeSend: function() {
                        Q = !0,
                        X += 1,
                        A = et.data("loading") && !et.hasClass("tg-no-more") && et.find("span").html(et.data("loading")),
                        A = t(it).length > 0 && 0 === et.length && t(it).addClass("tg-loading")
                    },
                    success: function(i) {
                        var n = i.success
                          , o = i.message
                        ...
                        if (e.data("ajax", a),
                        !n)
                            return et.add(t(it)).add(gt).removeClass("tg-loading"),
                            tt.find("> div").html(o),
                            et.find("span").html(o),
                            t(it).children("div").html(o),
                            X -= 1,
                            !1;
                        if (!r)
                            return et.data("item-tt", -1),
                            h(),
                            t(it).children("div").html(t(it).children("div").data("no-more")),
                            setTimeout(function() {
                                t(it).fadeOut(400)
                            }, 1e3),
                            X -= 1,
                            !1;
                        var s = t(r);
                        A = 0 === gt.length && s.addClass("tg-item-index"),
                        s.find(The_Grid.grid).length > 0 && (s = s.find(The_Grid.item).removeClass("tg-item-reveal")),
                        e.append(s),
                        rt = e.find(The_Grid.item),
                        s.hide(),
                        g(),
                        t.TG_media_init(),
                        c(),
            ...
            function b(e) {
                var n = e.length - 1;
                e.the_grid_images_loaded({
                    complete: function() {
                        var o, r = 0;
                        tt.hide(),
                        A = yt && t(it).removeClass("tg-loading"),
                        A = "horizontal" === _t.layout && H.css("min-height", ""),
                        A = "masonry" === _t.style && "horizontal" === _t.layout && y(),
                        o = window.tgInterval(function() {
                            if (H.closest("body").length > 0) {
                                if (H.TG_Layout("reLayout"),
                                A = _t.ajaxDelay && H.TG_Layout("appended", e.eq(r)),
                                A = "horizontal" === _t.layout && P.reload(),
                                n === r || !_t.ajaxDelay)
                                    return c(),
                                    h(),
                                    A = !_t.ajaxDelay && H.TG_Layout("appended", e),
                                    A = "horizontal" === _t.layout && P.reload(),
                                    gt.removeClass("tg-loading"),
                                    Q = !1,
                                    o.clear(),
                                    A = "undefined" != typeof FOOBOX && t.isFunction(FOOBOX.init) && FOOBOX.init(),
                                    A = t().fancybox && t(".tg-item a.fancybox").fancybox(),
                                    A = t().prettyPhoto && t('.tg-item  a[rel^="prettyPhoto"]').prettyPhoto(),
                                    i(rt),
                                    U.length > 0 && (U.splice(0, 1),
                                    U[0] && b(U[0])),
                                    !1;
                                r++
                            }
            ...
            function x() {
                J.length > 0 && TG_excludeItem()
            }
            var z, L, C, I, S, G, P, j, E, M, k, D, R, O, W, q, A, H = t(this), B = [], F = !0, N = !0, Y = !1, Q = !1, X = 1, V = null, U = [], $ = H.closest(The_Grid.wrapper).attr("id"), Z = t('[id="' + $ + '"]').length > 1 ? H.closest(The_Grid.wrapper) : t("#" + $), J = Z.closest(The_Grid.preview), K = Z.find(The_Grid.slider), tt = Z.find(The_Grid.loader), et = Z.find(The_Grid.ajax), it = Z.find(The_Grid.ajaxMsg), nt = Z.find(The_Grid.sizer), ot = Z.find(The_Grid.gutter), rt = Z.find(The_Grid.item), at = Z.find(The_Grid.filterH), st = Z.find(The_Grid.filter), lt = Z.find(The_Grid.search), ut = Z.find(The_Grid.clear), dt = Z.find(The_Grid.sorter), ct = Z.find(The_Grid.sorterBy), ht = Z.find(The_Grid.sortASC), ft = Z.find(The_Grid.arrLeft), pt = Z.find(The_Grid.arrRight), mt = Z.find(The_Grid.bullets), gt = Z.find(The_Grid.pages), yt = H.data(), vt = {
                style: yt.style && yt.style,
                layout: yt.layout && yt.layout,
                fitrows: yt.fitrows && yt.fitrows,
                fullWidth: yt.fullwidth && yt.fullwidth,
                fullHeight: yt.fullheight && yt.fullheight,
                rtl: yt.rtl && yt.rtl,
                filterComb: yt.filtercomb && yt.filtercomb,
                filterLogic: yt.filterlogic && yt.filterlogic,
                filterLoad: yt.filterload && yt.filterload,
                sortByLoad: yt.sortbyload && yt.sortbyload,
                orderLoad: yt.orderload && yt.orderload,
                row: yt.row && yt.row,
                ratio: yt.ratio && yt.ratio,
                gutters: yt.gutters && yt.gutters,
                cols: yt.cols && yt.cols,
                rows: yt.rows && yt.rows,
                animation: yt.animation && yt.animation,
                transition: yt.transition && yt.transition,
                itemNav: yt.slider && yt.slider.itemNav,
                swingSpeed: yt.slider && yt.slider.swingSpeed,
                cycleBy: yt.slider && yt.slider.cycleBy,
                cycle: yt.slider && yt.slider.cycle,
                startAt: yt.slider && yt.slider.startAt,
                ajaxMethod: yt.ajaxmethod && yt.ajaxmethod,
                ajaxDelay: yt.ajaxdelay && yt.ajaxdelay,
                preloader: yt.preloader && yt.preloader,
                itemDelay: yt.itemdelay && yt.itemdelay,
                gallery: yt.gallery && yt.gallery
            }, _t = t.extend({}, The_Grid.defaults, vt);
            _t.cols.sort(function(t, e) {
                return e[0] - t[0]
            }),
            _t.gutters.sort(function(t, e) {
                return e[0] - t[0]
            }),
            _t.rows.sort(function(t, e) {
                return e[0] - t[0]
            }),
            _t.rtl = !_t.rtl,
            _t.ajaxDelay = gt.length > 0 ? _t.itemDelay : _t.ajaxDelay;
            for (var wt = t.map(yt, function(t, e) {
                return e
            }), bt = 0; bt < wt.length; bt++)
                H.removeAttr("data-" + wt[bt]);
            s(),
            p(),
            g(),
            l(),
            c(),
            "masonry" === _t.style || "justified" === _t.style || _t.preloader || "horizontal" === _t.layout ? rt.the_grid_images_loaded({
                complete: function() {
                    y(),
                    v(),
                    _(),
                    A = _t.preloader && f(),
                    A = "horizontal" === _t.layout && H.TG_Layout("on", "arrangeComplete", function(t) {
                        e(t)
                    })
                }
            }) : (v(),
            ...
            Y = !_t.preloader && !0,
            A = Y && Z.addClass("tg-grid-loaded"),
            st.on("click", function(e) {
                var i = t(this);
                i.is("select") ? st.one("change", function() {
                    n(i.find("option:selected"))
                }) : n(i)
            }),
            tg_is_mobile ? ct.on("change", function() {
            ...
            var Tt = lt.keyup(debounce(function() {
                if (!Y)
                    return !1;
                var e = new RegExp(Tt.val(),"gi");
                rt.removeClass("tg-item-index"),
                st.removeClass("tg-filter-active"),
                H.TG_Layout({
                    filter: function() {
                        var i = t(this)
                          , n = !e || i.text().match(e);
                        return t('.tg-filter[data-filter="*"]').addClass("tg-filter-active"),
                        n && !0
                    }
                }),
                t.TG_Pause_Players()
            ...
            t(window).on(tg_debounce_resize, function() {
                ...
                g(),
                y(),
                A = Y && H.closest("body").length > 0 && H.TG_Layout("layout"),
                A = "horizontal" === _t.layout && H.TG_Layout("once", "layoutComplete", function(t) {
                    e(t)
                })
            }),
            gt.on("click", function(e) {
                ...
                var i = t(this);
                X = i.data("page"),
                i.is(".tg-page-current") || V && (!V || 4 != V.readyState) || Q || !Y || (dt.find(".tg-dropdown-value").text(""),
                lt.val(""),
                st.removeClass("tg-filter-active"),
                t('.tg-filter[data-filter="*"]').addClass("tg-filter-active"),
                gt.removeClass("tg-page-current").addClass("tg-loading"),
                i.addClass("tg-page-current"),
                t(".tg-item-hidden").addClass("tg-item-removed"),
                t.TG_media_destroy(H),
                H.css("min-height", 250).TG_Layout("remove", rt).TG_Layout({
                    filter: "*"
                }),
                H.contents().each(function() {
                    A = 8 == this.nodeType ? t(this).remove() : null
                }),
                tt.show(),
                w(H))
            }),
            ...
            "on_scroll" == _t.ajaxMethod && t(window).on("mousewheel resize scroll", function() {
                A = N && Z.length && Z[0].getBoundingClientRect().bottom < t(this).height() && !0 === Y && w(H)
            })
        })
    }
    ;
    ...
    t.fn.the_grid_images_loaded = function() {
        function i() {
            if (++a >= s.length)
                return r.complete.call(o),
                !1
        }
        var n, o = t(this), r = t.extend({
            complete: function() {}
        }, arguments[0] || {}), a = 0, s = [];
        o.find("*").filter(function() {
            n = t(this).css("background-image"),
            n = /^url\((['"]?)(.*)\1\)$/.exec(n),
            n = n ? n[2] : null,
            n = !n && t(this).is("img") ? t(this).attr("src") : n,
            (n = n && (n.match(/\.(jpg|jpeg|png|bmp|gif|tif|tiff|jif|jfif)/g) || n.indexOf("external.xx.fbcdn") >= 0 || n.indexOf("drscdn.500px.org") >= 0) ? n : null) && -1 == t.inArray(n, e) && (s.push(n),
            e.push(n))
        });
    ...
    t(document).ready(function() {
        function e(e) {
            if (e.data("list-DOM")) {
                var i = e.data("list-DOM").removeClass(o)
                  , n = setTimeout(function() {
                    i.remove(),
                    i = null,
                    e.data("list-DOM", i)
                }, 400);
                t(e.data("list-DOM")).data("list-timer", n)
            }
            return !1
        }
        function i(e) {
            var i = e.parent().offset()
              , n = e.parent().height()
              , o = "relative" === t("body").css("position") ? t(window).scrollTop() + t("body")[0].getBoundingClientRect().top : null
        ...
        var n, o = "tg-dropdown-holder-animation";
        tg_is_mobile || (t(document).on("mouseenter", ".tg-dropdown-holder", function(e) {
            e.preventDefault(),
            e.stopPropagation();
            var r = t(this)
            ...
            if (a)
                ...
                r.data("list-DOM").addClass(o),
                !1;
            var s = (n = r.find("ul")).clone(!0).addClass("tg-list-appended").attr("style", "").appendTo("body");
            r.add(s).data("list-DOM", s),
            s.data("filter-DOM", r);
            var l = i(r);
            n.hide(),
            s.css({
        ...
        t(document).on("mouseenter touchstart", ".tg-list-appended", function(e) {
            var i = t(this);
            if (i.data("list-DOM"))
                return clearTimeout(i.data("list-timer")),
                i.data("list-DOM").addClass(o),
                !1
        ...
        t(document).on("click touchstart", ".tg-list-appended li", function() {
            var e = t(this).closest("ul")
              , n = e.data("filter-DOM");
            n.find('[data-filter="' + t(this).data("filter") + '"]').trigger("click"),
            n.find('[data-value="' + t(this).data("value") + '"]').trigger("click"),
            e.width(n.outerWidth()),
            e.css("left", n.offset().left);
            var o = i(n);
            o.top !== e.position().top ? e.css("top", o.top) : (e.find("li").removeClass("tg-filter-active"),
            n.find(".tg-filter-active").each(function(i) {
                e.find("li").eq(t(this).index()).addClass("tg-filter-active")
            }))
        }))
    }),
    t.fn.TG_ToolTip = function(e) {
        t(document).on("mouseenter", t(this).selector, function() {
            var i = t(this);
            if (!i.data(e.data))
                return !1;
            if (i.data("tooltip-DOM"))
                return clearTimeout(i.data("tooltip-timer")),
                i.data("tooltip-DOM").addClass(e.hoverClass.split(".").join("")),
                !1;
            var n = t('<div class="' + e.appendClass.split(".").join("") + '"></div>').appendTo("body");
            i.data("tooltip-DOM", n);
            var o = i.data(e.data)
              , r = i.offset()
              , a = "relative" === t("body").css("position") ? t(window).scrollTop() + t("body")[0].getBoundingClientRect().top : null
              , s = r.top - a
              , l = r.left
              , u = i.outerWidth(!0);
            n.html(o).css({
                ...
                "z-index": e.zindex,
                width: u,
                top: s + e.spacing - n.outerHeight(!0),
                left: l + u / 2
            }).addClass(e.hoverClass.split(".").join(""))
        }).on("mouseleave", t(this).selector, function() {
            var i = t(this);
            if (!i.data(e.data) || !i.data("tooltip-DOM"))
                return !1;
            var n = i.data("tooltip-DOM").removeClass(e.hoverClass.split(".").join(""))
              , o = setTimeout(function() {
                n.remove(),
                n = null,
                i.data("tooltip-DOM", n)
            }, 400);
            i.data("tooltip-timer", o)
        })
    }
    ,
    t(document).ready(function() {
    ...
    t.fn.TG_Vimeo = function() {
        return this.each(function() {
            var e = t(this).closest(".tg-item")
              , i = t(this).attr("src");
            if (n <= 9 && (t(this).remove(),
            e.find(".tg-media-button").remove()),
    ...
    t.fn.TG_Wistia = function() {
        return this.each(function() {
            var e = t(this).closest(".tg-item")
              , i = t(this).attr("src");
            e.hasClass("tg-media-init") || "about:blank" === i || t(this).load(function() {
                ...
                i.bind("play", function() {
                    !1 === o && !1 === r && n && t.TG_Media_Play(e),
                    o = r = !1
                }),
                i.bind("pause", function() {
                    !1 === o && !1 === r && t.TG_Media_Pause(e),
                    r = n = !0
                }),
    ...
    t.fn.TG_HTML_Player = function() {
        return this.each(function() {
            ...
            if (!e.hasClass("tg-media-init")) {
                var i = t(this)[0];
                i.addEventListener && (t.TG_Media_Ready(e, i, "STD"),
    ...
    t.TG_Media_Ready = function(t, e, i) {
        t.data("pause-method", i).data("media-player", e).addClass("tg-media-init")
    }
    ,
    ...
    ,
    t(document).on("webkitfullscreenchange mozfullscreenchange fullscreenchange", function(e) {
        var i = t(e.target);
        t(".tg-item-media").removeClass("tg-item-media-fullscreen"),
        i && i.hasClass("tg-item-media") && i.addClass("tg-item-media-fullscreen")
    }),
    t(document).on("click", ".tg-item:not(.tg-media-init) .tg-item-button-play", function(e) {
        e.preventDefault();
    ...
    t(document).on("click", ".tg-item.tg-media-init .tg-item-button-play", function(e) {
        e.preventDefault();
        var i = t(this).closest(".tg-item")
          , n = i.data("pause-method")
          , o = i.data("media-player");
        if (i.is(".tg-force-play, .tg-is-playing"))
            return t.TG_Pause_Players(),
            !1;
        if (o && i.hasClass("tg-media-init"))
    ...
    t.TG_Pause_Players = function() {
        t(".tg-item.tg-is-playing, .tg-item.tg-force-play").each(function() {
            var e = t(this)
              ...
              , n = e.data("media-player");
            if (n && e.hasClass("tg-media-init")) {
                switch (i) {
                case "STD":
                    n.pause();
                    break;
    ...
    t.TG_media_init = function() {
        ...
        if (t(".g-ytsubscribe").length && ((e = document.createElement("script")).src = "https://apis.google.com/js/platform.js",
        e.id = "tg-youtube-subscribe-api",
        (o = document.getElementsByTagName("script")[0]).parentNode.insertBefore(e, o)),
        ...
        for (var a = 0; a < r.length; a++)
            n = r[a].ID,
            t('[data-api="1"].tg-item-' + n).length > 0 && (r[a].url,
            0 === t("#tg-" + n + "-api").length ? ((e = document.createElement("script")).src = r[a].url,
            e.id = "tg-" + n + "-api",
            (o = document.getElementsByTagName("script")[0]).parentNode.insertBefore(e, o),
            function(t, e) {
                t.onload = function() {
        ...
        t(document).ready(function() {
            ...
            tg_global_var.mediaelement && (t(".tg-item-video-player:not(.tg-mediaelement-init), .tg-item-audio-player:not(.tg-mediaelement-init)").mediaelementplayer({
                audioVolume: "vertical",
                videoVolume: "vertical",
                features: ["playpause", "current", "progress", "duration", "volume", "fullscreen"],
                startVolume: .8
            }),
            t(".tg-item-video-player, .tg-item-audio-player").addClass("tg-mediaelement-init"))
        })
    }
    ,
    t.TG_media_destroy = function(e) {
        ...
        (e = e ? e.find(".tg-item video, .tg-item audio") : t(".tg-item video, .tg-item audio")).each(function() {
            var e = t(this)
              , i = e.data("mediaelementplayer");
            e.closest(".tg-item").removeClass("tg-force-play tg-is-playing"),
            e.length && (i ? ((i = e.data("mediaelementplayer")).pause(),
    ...
    t.TO_Lightbox = function() {
        function e() {
            var e = t(C).filter(":visible");
            for (z = e.length,
            i = 0; i < z; i++) {
                var n = e.eq(i);
                L[i] = {},
                L[i].type = n.data("tolb-type"),
                L[i].src = n.data("tolb-src"),
                L[i].alt = n.data("tolb-alt"),
                L[i].poster = n.data("tolb-poster"),
                n.data(k, i)
            }
            z > 1 ? t(E + "," + M).show() : t(E + "," + M).hide()
        }
        function n(e) {
            ...
            T) {
            case "image":
                b = t('<img class="tolb-img" src="' + _ + '" alt="' + w + '"></img>'),
                (v = new Image).onload = a,
                v.onerror = a,
                v.src = _;
                break;
            case "youtube":
                b = t('<iframe class="tolb-video" src="' + (_ = "//www.youtube.com/embed/" + _ + "?html5=1&controls=1&autohide=1&rel=0&showinfo=0&autoplay=" + q) + '" allowfullscreen></iframe>'),
                l();
                break;
            case "vimeo":
                b = t('<iframe class="tolb-video" src="' + (_ = "//player.vimeo.com/video/" + _ + "?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=" + q) + '" allowfullscreen></iframe>'),
                l();
                break;
            case "wistia":
                b = t('<iframe class="tolb-video" src="' + (_ = "//fast.wistia.net/embed/iframe/" + _ + "?title=0&amp;byline=0&amp;portrait=0&amp;autoPlay=" + q) + '" allowfullscreen></iframe>'),
                l();
                break;
            case "video":
                for (var i = "", n = 0; n < _.length; n++)
                    i += '<source src="' + _[n][0].source + '" type="video/' + _[n][0].type + '" width="100%" height="100%"></source>';
                x = L[y].poster,
                b = t('<video class="tolb-video" controls' + (x = x ? ' poster="' + x + '"' : "") + (q ? " autoplay" : "") + ' width="100%">' + i + "</video>"),
                s()
            }
        }
        function o() {
            var e = t(I).find("iframe").not(b);
            e.length > 0 ? e.attr("src", "about:blank").one("load", function() {
                r()
            }) : r()
        }
        function r() {
            t(I).addClass(R),
            m = "iframe" !== T ? t(S).html("") : t(S).find("*").not(b).remove(),
        ...
        function s() {
            tg_is_mobile ? (m = g && g.setSrc("about:blank"),
            o()) : (b.one("loadeddata", function() {
                m = g && g.setSrc("about:blank"),
                tg_global_var.mediaelement ? u() : o()
            }),
        ...
        function d() {
            t(G).css("max-height", t(window).height() - 80 - t("#wpadminbar").height())
        }
        function c() {
            t(P).text(w),
            t(j).text(y + 1 + "/" + z)
        ...
        function p() {
            ...
            setTimeout(function() {
                t(I).find("iframe").length > 0 ? t(I).find("iframe").attr("src", "about:blank").one("load", function() {
                    t(S).html("")
                }) : t(S).html("")
            }, 300)
        }
        var m, g, y, v, _, w, b, T, x, z, L = [], C = "[data-tolb-src]:not(.tolb-disabled)", I = ".tolb-holder", S = ".tolb-content", G = ".tolb-img", P = ".tolb-title", j = ".tolb-counter", E = ".tolb-next", M = ".tolb-prev", k = "tolb-index", D = "tolb-open", R = "tolb-ready", O = "tolb-loading", W = "tolb-iframe", q = tg_global_var.lightbox_autoplay;
        t(window).on("resize", function() {
            d()
        }),
        t(document).on("click", C, function(i) {
            return i.preventDefault(),
            t.TG_Pause_Players(),
            t(".tolb-video," + G).remove(),
            e(),
            n(t(this)),
            !1
        }),
        t(document).on("click touchend", E + "," + M, function() {
            return n(t(this)),
            !1
        }),
        t(document).on("keydown", throttle(function(e) {
            t(I).hasClass(D) && (37 == e.keyCode ? t(M).trigger("click") : 39 == e.keyCode ? t(E).trigger("click") : 27 == e.keyCode && p())
        }, 300)),
        t(document).on("click touchend", ".tolb-inner,.tolb-close", function(e) {
            return e.stopPropagation(),
            (t(e.target).is(".tolb-inner") || t(e.target).is(".tolb-close")) && p(),
            !1
        }),
        t("body").append(t('<div class="tolb-holder"><div class="tolb-loader"></div><div class="tolb-inner"><figure><div class="tolb-close tg-icon-close"></div><div class="tolb-content"></div><figcaption><div class="tolb-title"></div><div class="tolb-counter"></div></figcaption></figure></div><div class="tolb-prev"><i class="tg-icon-arrow-prev-thin"></i></div><div class="tolb-next"><i class="tg-icon-arrow-next-thin"></i></div></div>'))
    }
    ,
    ...
    function() {
        var e, i, n, o, r, a, s = window.navigator.userAgent.indexOf("Edge/"), l = "div:not(.tg-item-gallery-holder) > .tg-item-image, .tg-item-media-poster, .tg-item-audio-poster, .tg-item-gallery-holder", u = 0;
        !("ontouchstart"in window || navigator.msMaxTouchPoints) && !t("body").hasClass("is-ie") && s < 0 && t(document).on("mousemove", ".tg-panZ", function(s) {
            e = t(this),
            o = e.width(),
            n = e.height(),
            ...
            window.requestAnimationFrame(function() {
                r = .08 * -(s.pageX - i.left - o / 2) * .4,
                a = .08 * -(s.pageY - i.top - n / 2) * .4,
                t(s.target).closest(".tg-item").find(l).css({
            ...
            setTimeout(function() {
                t(e.target).closest(".tg-item").find(l).css({
                    "-webkit-transform": "",
                    "-moz-transform": ""
                })
            }, 80)
    ...
    function() {
        function e(t, e) {
            var i = s.scrollTop || a.scrollTop
              ...
              , f = .52 - (r - l.top - i) / d
              , p = r - l.top - i - d / 2
              , m = .07 * c * (h - (o - l.left - n - u / 2))
              , g = .1 * c * (p - f)
              , y = "perspective(" + 3 * u * (d > u ? d / u * 2 : 1) + "px) rotateX(" + g + "deg) rotateY(" + m + "deg) scale3d(1.03,1.03,1.03)";
            e.css("transform", y + " translateX(" + 2 * h * (2.5 / c) + "px) translateY(" + 1 * f * (2.5 / c) + "px)")
        }
        function i(t) {
            t.addClass("over")
        }
        function n(t) {
            ...
            setTimeout(function() {
                ...
                t.css("transform", "perspective(" + 3 * e + "px) rotateX(0deg) rotateY(0deg) translateZ(0)")
            }, 80)
        }
        var o = document
          , r = 0
        ...
        l || t(document).on("mousemove", ".tg-atv-anim", function(i) {
            var n = t(this)
              , o = Date.now();
            o > r + u && (r = o,
            window.requestAnimationFrame(function() {
    ...
    t(document).on("click", ".tg-social-share:not(.tg-social-disabled)", function(e) {
        e.preventDefault();
        var i = t(this)[0].href
          , n = Math.round(window.screenX + (window.outerWidth - 626) / 2)
          , o = Math.round(window.screenY + (window.outerHeight - 436) / 2);
        return i && window.open(i, "tg_share", "status=0,resizable=1,location=1,toolbar=0,width=626,height=436,top=" + o + ",left=" + n),
        !1
    }),
    t.TG_media_init(),
    t(document).ready(function() {
        ...
        handler: function(t, e) {
            var i = this
              ...
              , o = function() {
                ...
                l.dispatch.apply(i, n)
            };
            s && clearTimeout(s),
            a = e ? o() : s = setTimeout(o, r.threshold)
        },
        threshold: 100
    }
}(jQuery),
...
window.tgInterval = function(t, e) {
    var i, n = Date.now, o = window.requestAnimationFrame, r = n(), a = function() {
        n() - r < e || (r += e,
        t()),
        i || o(a)
    };
